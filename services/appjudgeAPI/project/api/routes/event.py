...
#             # judge.set_event(event_id)
#             db.session.commit()
#             response_object['status'] = 'success'
#             response_object['message'] = "Valid payload"
#             response_object['judge_list'] = event.to_json()
#             # response_object['event_id'] = judge.to_json()
#             return jsonify(response_object), 201
#         else:
#             response_object['message'] = 'Sorry. That event or judge does not exist.'
#             return jsonify(response_object), 400
#     except exc.IntegrityError as e:
#         db.session.rollback()
#         return jsonify(response_object), 400
