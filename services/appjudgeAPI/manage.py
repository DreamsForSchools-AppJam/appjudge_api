...
def seedDB():
    ...
    db.session.add(Team(name='Dry Grass', info="Summer 2016", school_id=1, student_list=[1], mentor_list=[1]))
    db.session.add(Team(name='Hello Veggies', info="Summer 2017", school_id=2, student_list=[2], mentor_list=[2]))
